...
# %%
def multihead_masked_attention(Q: t.Tensor, K: t.Tensor, V: t.Tensor, num_heads: int, dropout: float):
    '''
...
class MultiheadMaskedAttention(nn.Module):
    ...
    def forward(self, x: t.Tensor) -> t.Tensor:
        ...
        attention_values = multihead_masked_attention(Q, K, V, self.num_heads, self.dropout)
