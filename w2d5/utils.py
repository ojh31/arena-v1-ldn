...
def test_sgd(SGD):
    ...
    for opt_config in test_cases:
        ...
        assert isinstance(w0_correct, t.Tensor)
        assert isinstance(w0_submitted, t.Tensor)
        t.testing.assert_close(w0_correct, w0_submitted, rtol=0.01, atol=1e-2)
...
def test_ExponentialLR(ExponentialLR, SGD):
    ...
    for config in test_cases:
        ...
        t.testing.assert_close(w0_correct, w0_submitted, rtol=0.01, atol=1e-3)
        t.testing.assert_close(b0_correct, b0_submitted, rtol=0.01, atol=1e-3)
